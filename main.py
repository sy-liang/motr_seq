...
def get_args_parser():
    ...
    parser.add_argument('--cls_loss_giou', default=1, type=float)
    parser.add_argument('--loss_varifocal', default=2, type=float)
    parser.add_argument('--loss_label', default=2, type=float)
